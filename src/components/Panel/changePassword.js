                        ...
                        <div className="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <i className="fa fa-eye" onClick={(e)=>this.showPasswordOld(e)} />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="newPassword" className="form-label">New Password</label>
                                    <input type={this.state.newPassword} name="newPassword" className="form-control" id="newPassword" />
                                    <i className="fa fa-eye" onClick={(f)=>this.showPasswordNew(f)}/>
                                </div>
                                <div className="mb-3">
                                    ...
                                    <i className="fa fa-eye" onClick={(g)=>this.showPasswordNewConfirm(g)}/>
                                </div>
